...
#if RobotMower
        _label2.text = [NSString stringWithFormat:@"%@%@",LocalString(@"App software version:"),LocalString(@" V0.3.2 for iOS")];
#elif RobotPark
        _label2.text = [NSString stringWithFormat:@"%@%@",LocalString(@"App software version:"),LocalString(@" V0.3.2 for iOS")];
#elif MOWOXROBOT
        _label2.text = [NSString stringWithFormat:@"%@%@",LocalString(@"App software version:"),LocalString(@" V2.3.2 for iOS")];
#endif
        //自动折行设置
